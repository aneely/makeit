...
- [ ] Implement `init` target in `Makefile` — copy scaffold files into `CONFIG_DIR`, print setup instructions
- [ ] Write BATS tests for `make init` behavior before implementing
- [ ] Manual end-to-end test: run `make init`, then `makeit work`, confirm Finder opens
- [ ] Update `PLAN.md` Makefile section to reflect final implementation
